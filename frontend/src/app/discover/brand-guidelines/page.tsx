...
export default function BrandGuidelinesPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/brand-guidelines')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.subtitle}>Our visual identity standards and brand usage guidelines.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/brand-guidelines/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
