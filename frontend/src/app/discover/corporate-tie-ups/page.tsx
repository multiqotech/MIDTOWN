...
export default function CorporateTieUpsPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/corporate-tie-ups')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.title}>Corporate Tie-ups</h1>
            <p className={styles.subtitle}>Strategic corporate healthcare partnerships for employee wellness.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/corporate-tie-ups/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
