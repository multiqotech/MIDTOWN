...
export default function WasteManagementDetailPage() {
      ...
      <>
        ...
        <main className={styles.main}>
          <div className={styles.notFound}>
            ...
            <p>The waste management initiative you are looking for does not exist or has been removed.</p>
            <Link href="/discover/waste-management" className={styles.backBtn}>
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.heroImageWrapper}>
            <Image
              src={item.image || 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?q=80&w=2000&auto=format&fit=crop'}
              alt={item.title}
              fill
          ...
          <div className={styles.heroContent}>
            <Link href="/discover/waste-management" className={styles.backLink}>
              &larr; Back to Waste Management
            </Link>
