...
export default function FinancialResultsPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/financial-results')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.subtitle}>Transparency in our financial performance and growth trajectory.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/financial-results/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
