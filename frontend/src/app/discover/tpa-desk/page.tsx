    ...
    <>
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          {data?.heroImage && <Image src={data.heroImage} alt={data.heroTitle || 'TPA Desk'} fill style={{ objectFit: 'cover' }} priority />}
          <div className={styles.overlay} />
          <div className={styles.heroContent}>
            <h1 className={styles.title}>{data?.heroTitle || 'TPA Desk'}</h1>
            <p className={styles.subtitle}>{data?.heroSubtitle || 'Third Party Administrator services for hassle-free claims and settlements.'}</p>
          </div>
        </section>
