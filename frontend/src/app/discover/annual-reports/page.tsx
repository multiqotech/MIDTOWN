...
export default function AnnualReportsPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/annual-reports')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.subtitle}>Comprehensive annual reviews of our operations, achievements and financial health.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/annual-reports/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
