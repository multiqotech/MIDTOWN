...
export default function CorporateAnnouncementsPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/corporate-announcements')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.title}>Corporate Announcements</h1>
            <p className={styles.subtitle}>Official announcements from Midtown Hospital leadership.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/corporate-announcements/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
