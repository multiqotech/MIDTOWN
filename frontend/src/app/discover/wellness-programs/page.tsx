...
export default function WellnessProgramsPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/wellness-programs')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.title}>Wellness Programs</h1>
            <p className={styles.subtitle}>Comprehensive wellness solutions for corporate partners.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/wellness-programs/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
