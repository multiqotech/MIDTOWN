...
export default function InsurancePartnersPage() {
  ...
  useEffect(() => {
    api.get('/api/discover/insurance-partners')
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.title}>Insurance Partners</h1>
            <p className={styles.subtitle}>Our network of trusted insurance partners for seamless healthcare.</p>
          </div>
        </section>
              ...
              {items.map((item: any) => (
                <div key={item._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {item.slug && (
                      <Link href={`/discover/insurance-partners/${item.slug}`} className={styles.cardLink}>
                        View Details →
                      </Link>
                    )}
                  </div>
