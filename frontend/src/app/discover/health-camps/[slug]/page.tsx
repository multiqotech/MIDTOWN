...
export default function HealthCampDetailPage() {
      ...
      <>
        ...
        <main className={styles.main}>
          <div className={styles.notFound}>
            ...
            <p>The health camp initiative you are looking for does not exist or has been removed.</p>
            <Link href="/discover/health-camps" className={styles.backBtn}>
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.heroImageWrapper}>
            <Image
              src={item.image || 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=2000&auto=format&fit=crop'}
              alt={item.title}
              fill
          ...
          <div className={styles.heroContent}>
            <Link href="/discover/health-camps" className={styles.backLink}>
              &larr; Back to Health Camps
            </Link>
