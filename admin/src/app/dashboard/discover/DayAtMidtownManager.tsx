                ...
                <div key={idx} style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', alignItems: 'flex-start' }}>
                  <div style={{ flex: 1 }}>
                      ...
                      <input 
                        type="text"
                        value={item.title || ''}
                        onChange={(e) => handleArrayChange('journeySteps', idx, 'title', e.target.value)}
                      ...
                      <input 
                        ...
                        onChange={(e) => handleArrayChange('journeySteps', idx, 'description', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                      ...
                      <input 
                        type="text"
                        value={item.icon || ''}
                        onChange={(e) => handleArrayChange('journeySteps', idx, 'icon', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                ...
                <div key={idx} style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', alignItems: 'flex-start' }}>
                  <div style={{ flex: 1 }}>
                      ...
                      <input 
                        type="text"
                        value={item.time || ''}
                        onChange={(e) => handleArrayChange('timelineItems', idx, 'time', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                        placeholder="Time"
                      />
                      ...
                      <input 
                        type="text"
                        value={item.title || ''}
                        onChange={(e) => handleArrayChange('timelineItems', idx, 'title', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                        placeholder="Title"
                      />
                      ...
                      <input 
                        type="text"
                        value={item.description || ''}
                        onChange={(e) => handleArrayChange('timelineItems', idx, 'description', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                        placeholder="Description"
                      />
                ...
                <div key={idx} style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', alignItems: 'flex-start' }}>
                  <div style={{ flex: 1 }}>
                      ...
                      <input 
                        type="text"
                        value={item.title || ''}
                        onChange={(e) => handleArrayChange('hospitalExperienceSections', idx, 'title', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                        placeholder="Title"
                      />
                      ...
                      <input 
                        type="text"
                        value={item.description || ''}
                        onChange={(e) => handleArrayChange('hospitalExperienceSections', idx, 'description', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
                        placeholder="Description"
                      />
                      ...
                      <input 
                        type="text"
                        value={item.image || ''}
                        onChange={(e) => handleArrayChange('hospitalExperienceSections', idx, 'image', e.target.value)}
                        style={{ width: '100%', padding: '0.5rem', backgroundColor: '#222', border: '1px solid #444', borderRadius: '4px', color: '#fff', marginBottom: '0.5rem' }}
