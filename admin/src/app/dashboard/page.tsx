...
import { LayoutDashboard, Image as ImageIcon, MapPin, Users, Settings, LogOut, UploadCloud, Link as LinkIcon, CheckCircle2, Stethoscope, Award, MessageSquare, PhoneCall } from 'lucide-react';
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#111', color: '#eee', fontFamily: 'var(--font-primary)' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflowY: 'auto' }}>
        ...
        <div style={{ padding: '2.5rem', maxWidth: '1000px' }}>
          ...
          {activeTab !== 'hero' && activeTab !== 'locations' && activeTab !== 'services' && activeTab !== 'whychoose' && activeTab !== 'doctors' && activeTab !== 'testimonials' && activeTab !== 'partners' && activeTab !== 'faqs' && activeTab !== 'enquiries' && (
